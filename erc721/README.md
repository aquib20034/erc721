# BaguetteBoys-smart-contracts
It is ERC721, Pausable and Ownable smart contact based on openzepplin (A library for secure smart contract development). This contrac includes the following features: 
* Pause/unpause the contract transaction at anytime
* Active/inactive public or whitelisting sale
